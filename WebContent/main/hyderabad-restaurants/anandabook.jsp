...
ResultSet rs = st.executeQuery("select imgid,booked from anandadb12 where imgid="+id );
if(rs.next())
{
int book = rs.getInt(2);
if(book==0)
{
ResultSet rs1 = st.executeQuery("UPDATE anandadb12 SET booked=1 WHERE imgid="+id);
response.sendRedirect("anandaorder.html");
}
else
{
response.sendRedirect("anandabook.html");
}
}
else
{
