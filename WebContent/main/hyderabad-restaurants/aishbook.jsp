...
ResultSet rs = st.executeQuery("select imgid,booked from aishdb12 where imgid="+id );
if(rs.next())
{
int book = rs.getInt(2);
if(book==0)
{
ResultSet rs1 = st.executeQuery("UPDATE aishdb12 SET booked=1 WHERE imgid="+id);
session.setAttribute("id",id);
response.sendRedirect("aishorder.html");
}
else
{
response.sendRedirect("aishbook.html");
}
}
else
{
...
<footer>
    <div class="footer row" style="background:#000">
            	...
            	<div class="col-lg-2 col-md-2 col-sm-2 white mrgn_btm20">
                	<a class="dineout_logo block" href="http://www.dineout.co.in/"><img src="" width="100" alt="Dineout" title="Dineout"></a>
