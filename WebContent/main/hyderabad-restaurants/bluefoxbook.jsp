...
ResultSet rs = st.executeQuery("select imgid,booked from bluefoxdb12 where imgid="+id );
if(rs.next())
{
int book = rs.getInt(2);
if(book==0)
{
ResultSet rs1 = st.executeQuery("UPDATE bluefoxdb12 SET booked=1 WHERE imgid="+id);
response.sendRedirect("bluefoxorder.html");
}
else
{
response.sendRedirect("bluefoxbook.html");
}
}
else
{
