    	...
    	<header>
            	<div class="row header">
                	<div class="col-lg-12 col-md-12 col-sm-12">
                    	<div class="clearfix">
                        <div class="pull-left">
                            <a class="navbar-brand dineout_logo pull-left" href="../index.html"><img src="../../images/5.jpg" height="50" width="100" alt="palette for your palate" title="palette for your palate"></a>
                        </div>
...
//ResultSet rs1=st.executeQuery("insert into "+name+"orders values('"+id+"','"+items+"')" );
for(String n:items){
		ResultSet rs = st.executeQuery("select * from aishorders where itemid="+n );
		if(rs.next())
		{
			%>
			<tr>
